...
class TestDSDFits(unittest.TestCase):
    ...
    def test_ua98_shape_gives_correct_value(self):
        ...
        self.assertTrue(
            np.isclose(shape, expected_shape),
    ...
    def test_ua98_slope_gives_correct_value(self):
        ...
        self.assertTrue(
            np.isclose(slope, expected_slope, rtol=1e-5, atol=1e-5),
    ...
    def test_ua98_intercept_gives_correct_value(self):
        ...
        self.assertTrue(
            np.isclose(intercept, expected_intercept, rtol=1e-5, atol=1e-5),
    ...
    def test_ua98_norm_intercept_gives_correct_value(self):
        ...
        self.assertTrue(
            np.isclose(intercept, expected_intercept),
