...
class TestNasa2DvdReaderIphexSubcase(unittest.TestCase):
    'Test module for the NASA_2DVD_reader class in pydisdrometer.aux_io.NASA_2DVD_reader for ifloods file'

    def setUp(self):
        filename = 'testdata/nasa_gv_iphex_2dvd_test.txt'
    ...
    def test_RR_works(self):
        ...
        self.assertEqual(len(self.dsd.fields['rain_rate']['data']), 10, 'Wrong number of time samples in rain rate')
    ...
    def test_can_run_calc_dsd_params(self):
        ...
        self.assertEqual(len(self.dsd.fields['D0']['data']), 10, 'Wrong number of samples in D0')
